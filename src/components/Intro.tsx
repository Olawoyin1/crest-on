        ...
        <div className="container">
            <div className="md:flex gap-10">
                ...
                <div className="flex flex-col flex-2/3 gap-3 mt-10 md:mt-0">
                    ...
                    <h3 className="font-extrabold text-3xl headings"><span className="text-blue-900">Crest Home</span> </h3>

                    <p className="">Founded in 2011, Crest Home is a trusted name in the UK property market, dedicated to helping individuals and families find their perfect homes and investment properties. With over a decade of experience, we specialize in residential, commercial, and strategic property management, offering tailored solutions that meet the diverse needs of our clients. <br /> <br />

                    Our mission is simple: to make property finding and management effortless, transparent, and personalized. Whether you’re a first-time buyer, seasoned investor, or a family searching for your dream home, Crest Home provides expert guidance and support at every step of your property journey. <br /> <br />
