...
//   return (
//     <header className="main-nav w-full relative z-50">
//       <nav
//         className={`fixed   top-0 left-0 w-full z-50 transition-all duration-300 ${
//           isHomePage && !scrolled ? "bg-transparent text-white" : "bg-white text-black shadow"
//         }`}
//       >
//         <div className="container h-[80px]">
//           <div className="h-full flex items-center justify-between  py-3">
...
//               <button onClick={toggleMenu}><RxHamburgerMenu size={24} /></button>
//             </div>
//           </div>
...
//         {/* Dropdown Menu (Full width inside container) */}
//         {hoveredMenu && (
//           <div
//             className="absolute top-12 left-0 w-full bg-white shadow-lg z-40"
