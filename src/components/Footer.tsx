      ...
      <div className="container mx-auto md:px-24 lg:px-0">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-gray-800">
                At Crest-Home, we provide seamless real estate solutions. Whether you are buying, selling, or renting, we simplify the process to help you find the perfect home.
              </p>
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-gray-600">
            © 2025 Crest Home Estate Agent Ltd. All rights reserved.
          </p>
